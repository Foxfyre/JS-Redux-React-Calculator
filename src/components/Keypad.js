    ...
    return (
      <div className="keypad">
        ...
        <div className="button-row-4x1">
          ...
          <ButtonSmall button={"."} id={"decimal"} value={'.'} display={this.props.display} />
        </div>
        <div className="button-col-1x5">
          <ButtonSmall button={"-"} id={"subtract"} />
          <ButtonLargeV button={"+"} id={"add"} display={this.props.display}/>
          <ButtonLargeV button={"="} id={"equals"} display={this.props.display}/>
        </div>
      </div>
    );
  }
